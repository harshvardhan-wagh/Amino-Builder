          ...
          {!calcResult ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p><strong>Sequence:</strong> {calcResult.sequence}</p>
                <p><strong>Length:</strong> {chain.length}</p>
                <p><strong>Molecular Weight:</strong> {calcResult.molecularWeight}</p>
              </div>

              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold mb-2">3D Preview</h3>
                <div className="w-full h-40 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-gray-500">3D Viewer Placeholder</span>
                </div>
              </div>
